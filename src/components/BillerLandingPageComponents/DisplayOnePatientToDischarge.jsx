...
const {first_name, last_name, age, sex	, address, city	, 
    ...
    treatment_given, treatment_advice, payment_made, mode_of_payment, date_discharge, date_admitted,
                ...
                <div className=''>
                    <div className='grid grid-cols-2 gap-2'>
                        ...
                        <div className='shadow-lg w-[400px]'>
                            ...
                            <input className='ms-10 text-center border-[1px] border-greenColor w-[155px]' type="date" id='entry_date' name="entry_date" placeholder='Entry Date...' value={entry_date || ""} onChange={handleInputChange}/>
                            </div>
                            ...
                            <input className='ms-10 text-center border-[1px] border-greenColor w-[155px]' type="date" id='date_admitted' name="date_admitted" placeholder='Date Admitted...' value={date_admitted || ""} onChange={handleInputChange}/>
                            </div>

                            <div className='flex justify-between mx-5 my-2 '>
                            <label htmlFor="date_discharge">Date Discharge</label>
                            <input className='ms-10 text-center border-[1px] border-greenColor w-[155px]' type="date" id='date_discharge' name="date_discharge" placeholder='Date Discharge...' value={date_discharge || ""} onChange={handleInputChange}/>
                            </div>
                        ...
                        <div className='shadow-lg'>
                            ...
                            <div className='flex justify-between items-center border-b-[2px] px-10 bg-slate-100'>
                                ...
                                <div className=''>
                                    ...
                                    <Link to={`/printdischargepatientdetails/${patient_number}`} >
                                            <button className='font-bold border-[1px] border-red-500 px-3 py-1 m-2 rounded-md hover:bg-red-400 hover:text-white '>Print Bill Records</button>
                                    </Link>
                                </div>
                            </div>
