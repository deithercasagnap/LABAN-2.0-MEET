                        ...
                        <div className='flex justify-between items-start '>
                            ...
                            <div className='flex justify-end items-start'>
                                <div className='flex justify-center bg-red-600 rounded-full hover:bg-slate-200 mx-2 mb-5 mt-2 w-[200px]'>
                                    <button className='text-white text-[11px] p-2  hover:text-textColor'><Link to={"/insertpatient"}>View Patients You've Discharged</Link></button>
                                </div>
                            </div>
                        </div>
