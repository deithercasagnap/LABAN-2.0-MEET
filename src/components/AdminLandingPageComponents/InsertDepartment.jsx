...
const {department_code, department_name, department_location, facilities} =  state;
...
const handleSubmit = (e) => {
    e.preventDefault();
    if(!department_code || !department_name || !department_location || !facilities){
                ...
                <div className='m-10 justify-center border-[1px] border-greenColor w-[40%]'>
                    ...
                    <div className='flex justify-center text-[12px]'>
                        <form  onSubmit={handleSubmit}>
                            ...
                            <input className='ms-[100px] text-center border-[1px] border-greenColor w-[200px]' type="number" id='department_code' name="department_code" placeholder='Department Code...' value={department_code || ""} onChange={handleInputChange}/>
                            </div>
                            ...
                            <input className='ms-10 text-center border-[1px] border-greenColor w-[200px]' type="text" id='facilities' name="facilities" placeholder='Facilities...' value={facilities || ""} onChange={handleInputChange}/>
                            </div>
