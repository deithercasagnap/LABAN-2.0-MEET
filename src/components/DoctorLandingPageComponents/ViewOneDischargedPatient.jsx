...
const ViewOneDischargedPatient = () => {
...
useEffect(() => {
    axios.get(`http://localhost:5002/api/get/viewonedischargedpatient/${patient_number}`).then((resp) => setState({...resp.data[0]}))
}, [patient_number])
...
export default ViewOneDischargedPatient