...
const ViewAdmittedPatients = () => {
    ...
    const loadData = async() => {
        const response = await axios.get("http://localhost:5002/api/get/showadmittedpatients");
        ...
        <div className=' justify-between mt-4'>
            <div className='grid grid-cols-2 items-center justify-between ms-3 me-3 border-b-[1px] py-[0.5rem] mb-3'>
                <div className='flex items-center' >
                    ...
                    <h4 className='text-[20px] text-blue-500'>All Admitted Patients</h4>
                ...
                <div className='mt-3'>
                    ...
                    <Link to={"/viewdischargedpatients"}>
            ...
            <table className='w-full h-[200px] justify-center text-[12px] text-center font-light p-10' >
                <thead className=" text-[12px] ">
                    ...
                    <tr>
                        ...
                        <th className='px-2 m-5'>Date of Admission</th>
                        ...
                        return (
                            <tr className='bg-white border-[1px] border-none hover:bg-gray-50 dark:hover:bg-gray-100'
                                ...
                                <td>
                                    ...
                                    <Link to={`/viewoneadmittedpatient/${item.patient_number}`} >
...
export default ViewAdmittedPatients;